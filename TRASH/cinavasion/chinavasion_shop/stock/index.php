...
function uploadForm()
{
	...
	<form action="" method="post" enctype="multipart/form-data">
		...
		<br /><input type="text" name="chinaData" value="Insert the date" /> !!! - date like in chinavasion google document [ year-month-day ]
...
if($_POST['update']=='ok')
{
	...
	else
	{
		...
		if(copy($_FILES["filename"]["tmp_name"],$path.$_FILES["filename"]["name"]))
		{
			...
			echo '<a href="http://cinavasion/stock/">go back</a>';
		}
		else
		{
